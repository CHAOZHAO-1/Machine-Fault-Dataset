...
|       [A5](#section-id5)      	|   2006   	|        辛辛那提大学（IMS）       	|      轴承（bearing）     	|       自然失效（Artificial   and RTF）       	|              /　              	|      Inner   race-outer race-ball 　     	|    振动（Acceleration）   	|          [data link]         	|         [data   link]        	|
|       [A6](#section-id6)      	|   2019   	|         都灵大学（DIRG）         	|      轴承（bearing）     	|  人工注入和自然失效（Artificial   and RTF）  	|              /　              	|                    /　                   	|   振动（Acceleration）　  	|          [data link]         	|         [data   link]        	|
|      [A7](#section-id7)      	|   2016   	|           自吸泵（SCP）          	|      轴承（bearing）     	|            人工注入（Artificial）            	|              /　              	|       Inner   race-outer race-ball       	|   振动（Acceleration）　  	|               /              	|         [data   link]        	|
|       [A8](#section-id8)     	|   2023   	|            哈工大(HIT)           	|      轴承（bearing）     	|            人工注入（Artificial）            	|              /　              	|          Inner   race-outer race         	|   振动（Acceleration）　  	|         [data   link]        	|         [data   link]        	|
|       [A9](#section-id9)      	|   2021   	|             SQV变转速            	|      轴承（bearing）     	|            人工注入（Artificial）            	|              /　              	|          Inner   race-outer race         	|   振动（Acceleration）　  	|          [data link]         	|         [data   link]        	|
|      [A10](#section-id10)     	|   2023   	|             越南大学             	|      轴承（bearing）     	|            人工注入（Artificial）            	|           3   type　          	|       Inner   race-outer race-ball       	|    振动（Acceleration）   	|               /              	|         [data   link]        	|
|      [A11](#section-id11)      	|   2021   	|              DC竞赛              	|      轴承（bearing）     	|                      /　                     	|              /　              	|                    /　                   	|            /　            	|               /              	|         [data   link]        	|
|      [A12](#section-id12)      	|   2024   	|  华中科技大学轴承（HUSTbearing） 	|      轴承（bearing）     	|          人工注入（Artificial）   　         	|           4   type　          	| Inner   race-outer race-ball-Combination 	|   振动（Acceleration）　  	|               /              	|         [data   link]        	|
|      [B1](#section-id13)      	|   2019   	|             东南大学             	|        齿轮(Gear)        	|          人工注入（Artificial）   　         	|           2   type　          	|                 5   type                 	|  振动（Acceleration）　　 	|          [data link]         	|         [data   link]        	|
|       [B2] (#section-id14)     	|   2009   	|               PHM09              	|        齿轮(Gear)        	|          人工注入（Artificial）   　         	|          10   type　          	|                    /　                   	|   振动（Acceleration）　  	|               /              	|         [data   link]        	|
|       [B3](#section-id15)      	|   2023   	|             行星齿轮             	|        齿轮(Gear)        	|           人工注入（Artificial）　           	|              /　              	|                    /　                   	|   振动（Acceleration）　  	|          [data link]         	|         [data   link]        	|
|       [B4](#section-id16)      	|   2021   	|             西安交通             	|        齿轮(Gear)        	|          人工注入（Artificial）   　         	|              /　              	|                    /　                   	|   振动（Acceleration）　  	|          [data link]         	|         [data   link]        	|
|       [B5](#section-id17)     	|   2021   	|            一阶减速器            	|        齿轮(Gear)        	|          人工注入（Artificial）   　         	|           6   type　          	|                 4   type                 	|   振动（Acceleration）　  	|          [data link]         	|         [data   link]        	|
|      [B6](#section-id18)      	|   2024   	|   华中科技大学齿轮（HUSTGear）   	|        齿轮(Gear)        	|          人工注入（Artificial）   　         	|           4   type　          	|                 3   type                 	|   振动（Acceleration）　  	|               /              	|         [data   link]        	|
|       [C1](#section-id19)      	|   2015   	|           工业过程故障           	|     工业过程(Process)    	|                      /　                     	|              /　              	|                 5   type                 	|        24 variables       	|               /              	|         [data   link]        	|
|       [C2](#section-id20)      	|   2020   	|            冷却机故障            	|      冷却机(Chiller)     	|                       /                      	|               /               	|                 7   type                 	|             /             	|               /              	|         [data   link]        	|
|      [C3](#section-id21)     	|   2019   	|             转子故障             	|        转子(Rotor)       	|                       /                      	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|         [data   link]        	|
|       [C4] (#section-id22)     	|   2018   	|              发动机              	|      发动机(Engine)      	|                       /                      	|               /               	|                     /                    	|             /             	|               /              	|         [data   link]        	|
|       [C5](#section-id23)      	|   2024   	|        海上石油勘探电浅泵        	|         泵(Pump)         	|                       /                      	|               /               	|                     /                    	|             /             	|               /              	|         [data   link]        	|
|       [C6](#section-id24)      	|   2023   	|      科大讯飞水泵状态挑战赛      	|        水泵(Pump)        	|                       /                      	|               /               	|                     /                    	|             /             	|               /              	|         [data   link]        	|
|       [C7] (#section-id25)    	|   2022   	|             德国火车             	|      火车轮毂(Train)     	|  人工注入和自然失效（Artificial   and RTF）  	|               /               	|                     /                    	|   振动（Acceleration）　  	|          [data link]         	|         [data   link]        	|
|       [C8] (#section-id26)     	|   2023   	|            变压器故障            	|    变压器(Transformer)   	|                       /                      	|               /               	|                     /                    	|             /             	|               /              	|         [data   link]        	|
|      [D1](#section-id27)     	|   2018   	|          西交全寿命周期          	|      轴承（bearing）     	|        自然失效（Artificial and RTF）        	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|          [data link]         	|
|       [D2](#section-id28)     	|   1996   	|             磨削退化             	|       刀具（Tool）       	|        自然失效（Artificial and RTF）        	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|          [data link]         	|
|       [D3](#section-id29)     	|   2021   	|               UNSW               	|      轴承（bearing）     	|        自然失效（Artificial and RTF）        	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|          [data link]         	|
|       [D4](#section-id30)      	|   2012   	|              PHM2012             	|      轴承（bearing）     	|        自然失效（Artificial and RTF）        	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|          [data link]         	|
|      [D5](#section-id31)     	|   2020   	|          CMPASS引擎退化          	|      轴承（bearing）     	|        自然失效（Artificial and RTF）        	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|          [data link]         	|
|       [D6](#section-id32)     	|   2010   	|              PHM2010             	|      轴承（bearing）     	|        自然失效（Artificial and RTF）        	|               /               	|                     /                    	|   振动（Acceleration）　  	|               /              	|          [data link]         	|
